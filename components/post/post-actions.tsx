...
export function PostActions({
  ...
  const actionsClass = isProfile
    ? 'mt-4 flex flex-wrap items-center gap-4 text-neutral-500 transition-colors hover:text-neutral-900 dark:hover:text-neutral-100'
    : 'mt-4 flex flex-wrap items-center gap-4 text-neutral-500 transition-colors hover:text-white';
